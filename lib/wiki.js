...
var writePage = function(name, content, callback) {
  this.getPage(name, function(err, page) {
    var lineEnding = (function() {
      // Get the most appropriate(most frequent) line ending from the given
      // content. If there are two or more most frequent line endings, the
      ...
      if (lf === most) {
        console.log('ed', 'lf', most);
        return '\n';
      } else if (crlf === most) {
        console.log('ed', 'crlf', most);
        return '\r\n';
      } else if (cr === most) {
        console.log('ed', 'cr', most);
        return '\r';
      }
    })();
