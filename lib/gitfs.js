...
var showFrom = function(filename, commitId, callback) {
    var gitfs = this;
...
var show = function(filename, callback) {
    ...
    this._getCommitIdFromHEAD(function(err, commitId) {
        if (err) throw err;
        gitfs.showFrom(filename, commitId, callback);
    });
}
        ...
        gitfs.readObject(commit.tree, function(err, tree) {
            ...
            if (commit.parent) {
                gitfs.log_from(filename, commit.parent, previousBlobId, function(err, nextCommits) {
                    callback(err, _.extend(commits, nextCommits));
                });
            } else {
