...
var queryLog = function(query, callback) {
    ...
    gitfs._computeCommitOffset(query, function(err, id) {
        if (err) { return callback(err, null); }
        query.until = id;
...
var _getBlobId = function(name, commitId, callback) {
    ...
    gitfs.readObject(commitId, function(err, commit) {
        gitfs.readObject(commit.tree, function(err, blobs) {
...
exports._computeCommitOffset = _computeCommitOffset;
exports._getBlobId = _getBlobId;
